...
$mirror = json_decode(`curl --silent https://api.github.com/repos/boombatower/drupal-squash/commits/7.x`, true);
$origin = json_decode(`curl --silent https://api.github.com/repos/drupal/drupal/commits/7.x`, true);
